...
module.exports = function (grunt) {
    ...
    var runCordova,
        ...
        cordova_plugins_map = {
            ...
            'crosswalk-webview':    'cordova-plugin-crosswalk-webview',
            'fcm':                 'cordova-plugin-fcm',
            'file-opener2':        'cordova-plugin-file-opener2',
            'filepath':            'cordova-plugin-filepath',
            'statusbar':           'cordova-plugin-statusbar',
            'whitelis':            'cordova-plugin-whitelist',
            'keyboard':            'ionic-plugin-keyboard',
            'inappbrowserxwalk':    'https://github.com/Shoety/cordova-plugin-inappbrowserxwalk',
            'FilePicker':          'https://github.com/jcesarmobile/FilePicker-Phonegap-iOS-Plugin.git',
            'filechooser':         'http://github.com/don/cordova-filechooser.git',
            'intent':              'https://github.com/napolitano/cordova-plugin-intent'
        },
